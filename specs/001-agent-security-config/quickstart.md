...
Edit `~/.twsrt/bash-rules.json` with your Bash deny/ask rules:
...
| `~/.twsrt/bash-rules.json` | Canonical: Bash deny/ask rules | Human (Tom) |
| `~/.twsrt/config.toml` | App config: paths to sources/targets | Human (Tom) |
